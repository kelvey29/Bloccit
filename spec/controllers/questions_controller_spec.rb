...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "GET #new" do
    ...
    it "increases the number of Question by 1" do
      expect{post :create, post: {title: RandomData.random_sentence, body: RandomData.random_paragraph}}.to change(Question,:count).by(1)
    end
  ...
  describe "PUT update" do
     it "updates question with expected attributes" do
       ...
       put :update, id: q.id, post: {title: new_title, body: new_body}
